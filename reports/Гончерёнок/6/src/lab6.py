...
for i in range(5):
    ...
    print(
        f"{t_val:5.1f} {Y_train[i]:10.3f} {predictions_train[i]:10.3f} {abs(Y_train[i] - predictions_train[i]):12.3f}")
...
for i in range(5):
    ...
    print(f"{t_val:5.1f} {Y_test[i]:10.3f} {predictions_test[i]:10.3f} {abs(Y_test[i] - predictions_test[i]):12.3f}")
